...
# ===========================================================
def parse_args():
    parser = argparse.ArgumentParser(description="Anomaly detection using Forecasting CNN Model")
    parser.add_argument("--input_csv", type=str, required=True, help="Path to input CSV file")
    parser.add_argument("--output_csv", type=str, default="./results/CNN/cnn_predictions.csv")
    parser.add_argument("--metrics_csv", type=str, default="./results/CNN/cnn_metrics.csv")
    parser.add_argument("--win_size", type=int, default=168, help="Window frame context size")
    parser.add_argument("--epochs", type=int, default=20, help="Training parameter context limits")
    parser.add_argument("--sliding_window", type=int, default=168, help="Metric mapping evaluation shift scope")
...
if __name__ == "__main__":
    ...
    print(f"Initializing Framework Execution Scope utilizing Convolutional Networks...")
    ...
    for b_id in tqdm(df.building_id.unique(), desc="Evaluating buildings"):
        ...
        # FIXED: Reshaped to 2D arrays so ForecastDataset doesn't throw an IndexError
        ...
        # 1. TRAIN
        # =========================================================
        pipeline = CNN(window_size=args.win_size, pred_len=1, epochs=args.epochs, feats=1)
